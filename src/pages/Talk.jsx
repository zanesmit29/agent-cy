...
export default function TalkPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a", color: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px 20px", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <h1 style={{ fontSize: "clamp(28px, 5vw, 48px)", fontWeight: "700", letterSpacing: "-1px", margin: "0 0 20px", textAlign: "center", lineHeight: 1.1 }}>
        Tell us who you are.
      </h1>
      {state === STATES.IDLE && (
      ...
      {state === STATES.CONNECTING && (
        <button disabled style={{ background: "#1a1a1a", color: "#555", border: "1px solid #2a2a2a", borderRadius: "100px", padding: "16px 40px", fontSize: "16px", fontWeight: "600", cursor: "not-allowed" }}>
          Connecting...
        </button>
      )}
      {state === STATES.LIVE && (
        <button onClick={handleEnd} style={{ background: "transparent", color: "#555", border: "1px solid #2a2a2a", borderRadius: "100px", padding: "14px 36px", fontSize: "14px", fontWeight: "500", cursor: "pointer" }}>
          End conversation
        </button>
      )}
