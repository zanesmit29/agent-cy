    ...
    <div className="min-h-screen bg-[#0a0d10] flex flex-col text-[#f5f0e8]">
      ...
      <header className="px-6 md:px-10 py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-white/[0.07] gap-3 sm:gap-0">
        ...
        <div
          ...
          style={{ background: "rgba(237, 233, 224, 0.12)", borderRadius: "8px", padding: "10px 20px", border: "1px solid rgba(237, 233, 224, 0.25)" }}
        >
          <span className="font-sans text-[13px] text-[#ede9e0] opacity-60 tracking-[0.3px] font-light">
            powered by
          </span>
          <img
